      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            <a href="#" className="text-sm text-muted hover:text-ink transition-colors">Features</a>
            <a href="#" className="text-sm text-muted hover:text-ink transition-colors">Protocol</a>
            <a href="#" className="text-sm text-muted hover:text-ink transition-colors">Pricing</a>
          ...
          <div className="flex flex-col gap-3">
            ...
            <a href="#" className="text-sm text-muted hover:text-ink transition-colors">CLI Reference</a>
            <a href="#" className="text-sm text-muted hover:text-ink transition-colors">SM-2 Deep Dive</a>
