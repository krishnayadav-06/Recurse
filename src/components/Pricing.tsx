      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <div className="flex items-center justify-center gap-4 mt-8">
            ...
            {isAnnual && (
              <span className="font-mono text-signal text-xs font-semibold bg-blue-50 px-2 py-1 rounded-full border border-blue-200">
                Save 20%
              </span>
            )}
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          ...
          <div className="rounded-xl border-gray-900 ring-1 ring-gray-900 p-6 md:p-8 bg-white flex flex-col relative transform md:-translate-y-4">
            ...
            <ul className="flex flex-col gap-4 mb-8 flex-1">
              ...
              <li className="flex gap-3 text-sm text-muted items-start">
                <Check size={16} className="text-ink shrink-0 mt-0.5" />
                <span>Advanced SM-2 tuning</span>
              </li>
              <li className="flex gap-3 text-sm text-muted items-start">
                <Check size={16} className="text-ink shrink-0 mt-0.5" />
                <span>Terminal CLI access</span>
          ...
          <div className="rounded-xl border border-border-light p-6 md:p-8 bg-white flex flex-col hover:border-gray-300 transition-colors">
            <div className="mb-6">
              <h3 className="font-semibold text-ink mb-2">Team</h3>
              <div className="flex items-baseline gap-1">
                <span className="text-4xl font-extrabold text-ink font-mono tracking-tighter">
                  {isAnnual ? '$24' : '$30'}
                </span>
            ...
            <ul className="flex flex-col gap-4 mb-8 flex-1">
              <li className="flex gap-3 text-sm text-muted items-start">
                <Check size={16} className="text-ink shrink-0 mt-0.5" />
                <span>Everything in Engineer</span>
              </li>
              <li className="flex gap-3 text-sm text-muted items-start">
                <Check size={16} className="text-ink shrink-0 mt-0.5" />
                <span>Shared team queues</span>
              </li>
              <li className="flex gap-3 text-sm text-muted items-start">
                <Check size={16} className="text-ink shrink-0 mt-0.5" />
                <span>Interview prep tracks</span>
              </li>
              <li className="flex gap-3 text-sm text-muted items-start">
                <Check size={16} className="text-ink shrink-0 mt-0.5" />
                <span>SSO & Central billing</span>
              </li>
            </ul>
