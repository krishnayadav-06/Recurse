...
function AuthModalContent() {
  ...
  const handleEmailAction = async (e: React.FormEvent) => {
    ...
    const nextPath = window.location.pathname === '/' ? '/app/problems' : window.location.pathname;
        ...
        {authView === 'confirm' ? (
          ...
          <>
            ...
            <p className="text-sm text-gray-500 mb-6 text-center">
              {authView === 'login' ? 'Log in to your account' : 'Start reviewing smarter'}
            </p>
                ...
                {isLoading ? (
                  <>
                    ...
                    <span className="font-mono">
                      {authView === 'login' ? 'Logging in…' : 'Creating…'}
                    </span>
                  </>
                ) : (
